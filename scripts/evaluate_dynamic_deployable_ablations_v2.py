...
def main() -> None:
    ...
    for name, definition in definitions.items():
        ...
        for candidate in candidates:
            ...
            row = simulate_deployable_dynamic_policy(
                ...
                candidate_value, mu_value=float(candidate["mu"]),
        ...
        results[name] = {
            ...
            "candidate_count": len(local_curve),
            "calibration_curve": local_curve,
            "candidate_feasibility": candidate_feasibility_counts(
                local_curve, float(dense_calibration["dense_accuracy"]),
                float(definition["epsilon"]),
        ...
        for family, bounds in (
            ...
            for raw_bound in bounds:
                ...
                if selected.get("dense_fallback"):
                    ...
                    evaluated = simulate_deployable_dynamic_policy(
                        frames["heldout"], transformed_stop["heldout"], transformed_risk["heldout"],
                        heldout_value, mu_value=float(candidate["mu"]),
    ...
    payload = {
        ...
        "cost": "reasoning_tokens_only_in_Q_target", "short_answer_cost": 0,
        "online_future_cost_access": False,
