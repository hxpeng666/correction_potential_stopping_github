#!/usr/bin/env python3
"""Train the controlled 2566-D probe with the existing normalized trajectory loss."""
...
from src.dynamic_optimal_stopping_deployable_v2 import build_dynamic_features
