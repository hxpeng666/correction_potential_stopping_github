#!/usr/bin/env python3
"""Collect full Dense and Direct trajectories for a final-paper split."""
...
def main() -> None:
    ...
    for local_index, record in enumerate(records):
        ...
        example_seed = stable_example_seed(args.seed, problem_id, "dense")
        ...
        with torch.inference_mode():
            direct_trace = generate_trace(
                ...
                direct_mask,
                direct_generation,
                stable_example_seed(args.seed, problem_id, "direct"),
            )
